...
namespace Aethers.Notebook.DataAccess
{
    ...
    partial void InsertCatalog(Aethers.Notebook.Model.Catalog instance);
    partial void UpdateCatalog(Aethers.Notebook.Model.Catalog instance);
    partial void DeleteCatalog(Aethers.Notebook.Model.Catalog instance);
    partial void InsertUserCatalog(Aethers.Notebook.Model.UserCatalog instance);
    partial void UpdateUserCatalog(Aethers.Notebook.Model.UserCatalog instance);
    partial void DeleteUserCatalog(Aethers.Notebook.Model.UserCatalog instance);
    partial void InsertResourceQuery(Aethers.Notebook.Model.ResourceQuery instance);
    partial void UpdateResourceQuery(Aethers.Notebook.Model.ResourceQuery instance);
    partial void DeleteResourceQuery(Aethers.Notebook.Model.ResourceQuery instance);
    #endregion
		...
		public System.Data.Linq.Table<Aethers.Notebook.Model.Catalog> Catalogs
		{
			get
			{
				return this.GetTable<Aethers.Notebook.Model.Catalog>();
			}
		}
		
		public System.Data.Linq.Table<Aethers.Notebook.Model.UserCatalog> UserCatalogs
		{
			get
			{
				return this.GetTable<Aethers.Notebook.Model.UserCatalog>();
			}
		}
		
		public System.Data.Linq.Table<Aethers.Notebook.Model.ResourceQuery> ResourceQueries
		{
			get
			{
				return this.GetTable<Aethers.Notebook.Model.ResourceQuery>();
			}
		}
...
namespace Aethers.Notebook.Model
{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _friendlyIdentifer;
    ...
    partial void OndisplayNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_friendlyIdentifer", DbType="NVARCHAR(MAX)")]
		public string friendlyIdentifier
		{
			get
			{
				return this._friendlyIdentifer;
			}
			set
			{
				if ((this._friendlyIdentifer != value))
				{
					this.OnfriendlyIdentifierChanging(value);
					this.SendPropertyChanging();
					this._friendlyIdentifer = value;
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserCatalog", Storage="_UserCatalogs", ThisKey="ID", OtherKey="UserID")]
    ...
    partial void OnIDChanging(long value);
    partial void OnIDChanged();
    partial void OncatalogUriChanging(string value);
    partial void OncatalogUriChanged();
    ...
    partial void OnresourceIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_catalogUri", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string catalogUri
		{
			...
			set
			{
				...
				{
					this.OncatalogUriChanging(value);
					this.SendPropertyChanging();
					this._catalogUri = value;
					this.SendPropertyChanged("catalogUri");
					this.OncatalogUriChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_resourceID", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Catalog_UserCatalog", Storage="_UserCatalogs", ThisKey="ID", OtherKey="CatalogID")]
		public EntitySet<UserCatalog> UserCatalogs
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.UserCatalog")]
	public partial class UserCatalog : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ResourceQuery> _ResourceQueries;
    ...
    partial void OnstateChanging(string value);
    partial void OnstateChanged();
    partial void OnstatusChanging(StatusCode value);
    partial void OnstatusChanged();
    ...
    partial void Onaccess_tokenChanged();
		...
		public UserCatalog()
		{
			this._ResourceQueries = new EntitySet<ResourceQuery>(new Action<ResourceQuery>(this.attach_ResourceQueries), new Action<ResourceQuery>(this.detach_ResourceQueries));
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_auth_code", DbType="NVarChar(MAX)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserCatalog_ResourceQuery", Storage="_ResourceQueries", ThisKey="ID", OtherKey="userCatalogID")]
		public EntitySet<ResourceQuery> ResourceQueries
		{
			get
			{
				return this._ResourceQueries;
			}
			set
			{
				this._ResourceQueries.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Catalog_UserCatalog", Storage="_Catalog", ThisKey="CatalogID", OtherKey="ID", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_UserCatalog", Storage="_User", ThisKey="UserID", OtherKey="ID", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		private void attach_ResourceQueries(ResourceQuery entity)
		{
			this.SendPropertyChanging();
			entity.UserCatalog = this;
		}
		
		private void detach_ResourceQueries(ResourceQuery entity)
		{
			this.SendPropertyChanging();
			entity.UserCatalog = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ResourceQuery")]
	public partial class ResourceQuery : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.DateTime _expiry_time;
		
		private long _userCatalogID;
		
		private bool _processed;
		
		private string _access_token;
		
		private EntityRef<UserCatalog> _UserCatalog;
    ...
    partial void Onexpiry_timeChanging(System.DateTime value);
    partial void Onexpiry_timeChanged();
    partial void OnuserCatalogIDChanging(long value);
    partial void OnuserCatalogIDChanged();
    ...
    partial void Onaccess_tokenChanged();
		...
		{
			this._UserCatalog = default(EntityRef<UserCatalog>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_client_id", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_query", DbType="NText NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public string query
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_expiry_time", DbType="DateTime2 NOT NULL")]
		public System.DateTime expiry_time
		{
			get
			{
			...
			set
			{
				...
				{
					this.Onexpiry_timeChanging(value);
					this.SendPropertyChanging();
					this._expiry_time = value;
					this.SendPropertyChanged("expiry_time");
					this.Onexpiry_timeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_userCatalogID", DbType="BigInt NOT NULL")]
		public long userCatalogID
		{
			get
			{
			...
			set
			{
				if ((this._userCatalogID != value))
				{
					if (this._UserCatalog.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnuserCatalogIDChanging(value);
					this.SendPropertyChanging();
					this._userCatalogID = value;
					this.SendPropertyChanged("userCatalogID");
					this.OnuserCatalogIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_access_token", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string access_token
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserCatalog_ResourceQuery", Storage="_UserCatalog", ThisKey="userCatalogID", OtherKey="ID", IsForeignKey=true)]
		public UserCatalog UserCatalog
		{
			get
			{
				return this._UserCatalog.Entity;
			}
			set
			{
				UserCatalog previousValue = this._UserCatalog.Entity;
				if (((previousValue != value) 
							|| (this._UserCatalog.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._UserCatalog.Entity = null;
						previousValue.ResourceQueries.Remove(this);
					}
					this._UserCatalog.Entity = value;
					if ((value != null))
					{
						value.ResourceQueries.Add(this);
						this._userCatalogID = value.ID;
					}
					else
					{
						this._userCatalogID = default(long);
					}
					this.SendPropertyChanged("UserCatalog");
				}
			}
		}
